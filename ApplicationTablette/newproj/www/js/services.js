  ...
  var idTel;
	...
	socket.on("PROFILES", function(data)
	{
		...
		for (var i = 0 ; i < data.length ; i++)
		{
			...
			console.log(profile);
			Profils.add({id : i, prenom: profile[0], nom: profile[1],idTel:null, position: {longitude: null , latitude: null}, highlighted: false, face: 'img/person-flat.png',idImage: true})
		}
